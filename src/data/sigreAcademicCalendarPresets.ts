...
export const DEFAULT_LEGEND_ITEMS_2026_2027: SigreCalendarLegendItem[] = [
  ...
  {
    id: "leg_ud_02",
    code: "UD02. BC1 (13h • 7 ses.)",
    title: "UD02. Interpretación de esquemas y simbología de instalaciones térmicas",
    type: "ud_ra",
  ...
  {
    id: "leg_ud_03",
    code: "UD03. BC1 (13h • 7 ses.)",
    title: "UD03. Selección de componentes térmicos y fotovoltaicos",
    type: "ud_ra",
  ...
  {
    id: "leg_ud_04",
    code: "UD04. BC2 (14h • 7 ses.)",
    title: "UD04. Planificación, replanteo y montaje de estructuras",
    type: "ud_ra",
  ...
  {
    id: "leg_ud_05",
    code: "UD05. BC2 (15h • 8 ses.)",
    title: "UD05. Montaje e interconexión de colectores y redes",
    type: "ud_ra",
  ...
  {
    id: "leg_ud_06",
    code: "UD06. BC3 (13h • 7 ses.)",
    title: "UD06. Pruebas de estanqueidad y presión hidráulica",
    type: "ud_ra",
  ...
  {
    id: "leg_ud_07",
    code: "UD07. BC3 (13h • 7 ses.)",
    title: "UD07. Llenado, purgado y equilibrado para la puesta en servicio",
    type: "ud_ra",
  ...
  {
    id: "leg_ud_08",
    code: "UD08. BC4 (14h • 7 ses.)",
    title: "UD08. Mantenimiento preventivo e higienización",
    type: "ud_ra",
...
export const PRESET_CALENDAR_2025_2026: SigreAcademicCalendar = {
  ...
  legendItems: [
    ...
    { id: "leg25_ra08", code: "UD01. BC7 (14h • 7 ses.)", title: "UD01. Prevención de riesgos laborales y protección ambiental", type: "ud_ra", color: "#fcd5b4", textColor: "#431407", monthTarget: 9 },
    { id: "leg25_ra01", code: "UD02. BC1 (13h • 7 ses.)", title: "UD02. Interpretación de esquemas y simbología de instalaciones térmicas", type: "ud_ra", color: "#e2d5e8", textColor: "#3b0764", monthTarget: 10 },
    { id: "leg25_ra02", code: "UD03. BC1 (13h • 7 ses.)", title: "UD03. Selección de componentes térmicos y fotovoltaicos", type: "ud_ra", color: "#f5deb3", textColor: "#7c2d12", monthTarget: 11 },
    { id: "leg25_ra03", code: "UD04. BC2 (14h • 7 ses.)", title: "UD04. Planificación, replanteo y montaje de estructuras", type: "ud_ra", color: "#fff2b2", textColor: "#713f12", monthTarget: 12 },
    { id: "leg25_ra04", code: "UD05. BC2 (15h • 8 ses.)", title: "UD05. Montaje e interconexión de colectores y redes", type: "ud_ra", color: "#ffc482", textColor: "#7c2d12", monthTarget: 1 },
    { id: "leg25_dual", code: "DUAL", title: "Formación Dual (02/02 - 20/02 - 120h)", type: "dual", color: "#fff2b2", textColor: "#713f12", monthTarget: 2 },
    { id: "leg25_ra05", code: "UD06. BC3 (13h • 7 ses.)", title: "UD06. Pruebas de estanqueidad y presión hidráulica", type: "ud_ra", color: "#99e6ff", textColor: "#0c4a6e", monthTarget: 3 },
    { id: "leg25_ra06", code: "UD07. BC3 (13h • 7 ses.)", title: "UD07. Llenado, purgado y equilibrado para la puesta en servicio", type: "ud_ra", color: "#b2e6b2", textColor: "#14532d", monthTarget: 4 },
    { id: "leg25_ra07", code: "UD08. BC4 (14h • 7 ses.)", title: "UD08. Mantenimiento preventivo e higienización", type: "ud_ra", color: "#80deea", textColor: "#134e4a", monthTarget: 5 },
...
export const PRESET_CALENDAR_2026_2027_IST: SigreAcademicCalendar = {
  ...
  legendItems: [
    ...
    { id: "ist_ud_01", code: "UD01. RA01 (20h • 10 ses.)", title: "UD01. Radiación solar y captadores térmicos", type: "ud_ra", color: "#fcd5b4", textColor: "#431407", monthTarget: 9, udId: "UD01" },
    { id: "ist_ud_02", code: "UD02. RA02 (22h • 11 ses.)", title: "UD02. Circuitos primario y secundario de fluidos", type: "ud_ra", color: "#e2d5e8", textColor: "#3b0764", monthTarget: 10, udId: "UD02" },
    { id: "ist_ud_03", code: "UD03. RA03 (24h • 12 ses.)", title: "UD03. Sistemas de acumulación, purgado y seguridad", type: "ud_ra", color: "#f5deb3", textColor: "#7c2d12", monthTarget: 11, udId: "UD03" },
    { id: "ist_ud_04", code: "UD04. RA04 (24h • 12 ses.)", title: "UD04. Regulación electrónica y control solar", type: "ud_ra", color: "#fff2b2", textColor: "#713f12", monthTarget: 12, udId: "UD04" },
    ...
    { id: "ist_ud_05", code: "UD05. RA05 (25h • 13 ses.)", title: "UD05. Montaje e interconexión de campos solares", type: "ud_ra", color: "#99e6ff", textColor: "#0c4a6e", monthTarget: 3, udId: "UD05" },
    { id: "ist_ud_06", code: "UD06. RA06 (25h • 13 ses.)", title: "UD06. Puesta en marcha, mantenimiento e higienización", type: "ud_ra", color: "#b2e6b2", textColor: "#14532d", monthTarget: 4, udId: "UD06" },
...
export const PRESET_CALENDAR_2026_2027_DIG: SigreAcademicCalendar = {
  ...
  legendItems: [
    ...
    { id: "dig_ud_01", code: "UD01. RA01 (16h • 8 ses.)", title: "UD01. Entornos cloud, gemelos digitales e IoT en instalaciones", type: "ud_ra", color: "#80deea", textColor: "#134e4a", monthTarget: 9, udId: "UD01" },
    { id: "dig_ud_02", code: "UD02. RA02 (14h • 7 ses.)", title: "UD02. Ciberseguridad y protección de datos en infraestructuras", type: "ud_ra", color: "#c7d2fe", textColor: "#3730a3", monthTarget: 11, udId: "UD02" },
    { id: "dig_ud_03", code: "UD03. RA03 (15h • 8 ses.)", title: "UD03. Inteligencia Artificial y analítica de datos en mantenimiento", type: "ud_ra", color: "#fbcfe8", textColor: "#831843", monthTarget: 1, udId: "UD03" },
    { id: "dig_ud_04", code: "UD04. RA04 (15h • 8 ses.)", title: "UD04. Economía circular y gemelo digital en el sector térmico", type: "ud_ra", color: "#a7f3d0", textColor: "#065f46", monthTarget: 4, udId: "UD04" },
...
export const PRESET_CALENDAR_2026_2027_CIT: SigreAcademicCalendar = {
  ...
  legendItems: [
    ...
    { id: "cit_ud_01", code: "UD01. RA01 (24h • 12 ses.)", title: "UD01. Cálculo de cargas térmicas de calefacción y refrigeración", type: "ud_ra", color: "#fcd5b4", textColor: "#431407", monthTarget: 9, udId: "UD01" },
    { id: "cit_ud_02", code: "UD02. RA02 (26h • 13 ses.)", title: "UD02. Dimensionado de redes hidráulicas y bombas centrífugas", type: "ud_ra", color: "#e2d5e8", textColor: "#3b0764", monthTarget: 10, udId: "UD02" },
    { id: "cit_ud_03", code: "UD03. RA03 (26h • 13 ses.)", title: "UD03. Selección de calderas, bombas de calor y aerotermia", type: "ud_ra", color: "#f5deb3", textColor: "#7c2d12", monthTarget: 11, udId: "UD03" },
    { id: "cit_ud_04", code: "UD04. RA04 (26h • 13 ses.)", title: "UD04. Dimensionado de conductos de aire y UTA según RITE", type: "ud_ra", color: "#fff2b2", textColor: "#713f12", monthTarget: 12, udId: "UD04" },
    ...
    { id: "cit_ud_05", code: "UD05. RA05 (26h • 13 ses.)", title: "UD05. Sistemas de regulación DDC, domótica y KNX", type: "ud_ra", color: "#99e6ff", textColor: "#0c4a6e", monthTarget: 3, udId: "UD05" },
    { id: "cit_ud_06", code: "UD06. RA06 (26h • 13 ses.)", title: "UD06. Eficiencia energética y certificación en edificios", type: "ud_ra", color: "#b2e6b2", textColor: "#14532d", monthTarget: 4, udId: "UD06" },
    { id: "cit_ud_07", code: "UD07. RA07 (26h • 13 ses.)", title: "UD07. Elaboración de memoria técnica y planos de proyecto", type: "ud_ra", color: "#80deea", textColor: "#134e4a", monthTarget: 5, udId: "UD07" },
