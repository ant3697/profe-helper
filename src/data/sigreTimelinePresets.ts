import { TimelineEvent, TimelineColorPreset, SigreCourseTimelineItem } from "../types/sigreTimeline";
...
// Generates multiple course-level timelines (general, 1º FP, 2º FP Dual, etc.)
export function getDefaultCursoCronogramas(startYear = 2026): SigreCourseTimelineItem[] {
  const y1 = startYear;
  const y2 = startYear + 1;
  const baseEvents = getDefaultCursoTimelineEvents(startYear);

  return [
    {
      id: "curso_general_centro",
      name: "Calendario Escolar y Marco General de Centro",
      category: "General Centro",
      academicYear: `${y1}-${y2}`,
      events: baseEvents,
    },
    {
      id: "curso_fp_1_anual",
      name: "Plan FP 1º Curso (32 semanas + Periodo Ordinario y Junio)",
      category: "1º Curso FP",
      academicYear: `${y1}-${y2}`,
      events: [
        {
          id: 1201,
          description: "Jornada de Recepción y Evaluación Inicial de Competencias (1º FP)",
          startDate: `${y1}-09-15`,
          endDate: `${y1}-09-19`,
          category: "lectivo",
          level: "curso",
        ...
        {
          id: 1202,
          description: "1er Bloque Formativo Modular (Semanas 1 a 12)",
          startDate: `${y1}-09-15`,
          endDate: `${y1}-12-05`,
          category: "lectivo",
          level: "curso",
        ...
        {
          id: 1203,
          description: "1ª Evaluación Parcial (Sesiones de Evaluación 1T)",
          startDate: `${y1}-12-10`,
          endDate: `${y1}-12-12`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1205,
          description: "2º Bloque Formativo Modular (Semanas 13 a 24)",
          startDate: `${y2}-01-08`,
          endDate: `${y2}-03-20`,
          category: "lectivo",
          level: "curso",
        ...
        {
          id: 1206,
          description: "2ª Evaluación Parcial (Sesiones de Evaluación 2T)",
          startDate: `${y2}-03-24`,
          endDate: `${y2}-03-26`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1208,
          description: "3er Bloque Formativo Modular (Semanas 25 a 32)",
          startDate: `${y2}-04-07`,
          endDate: `${y2}-06-05`,
          category: "lectivo",
          level: "curso",
        ...
        {
          id: 1209,
          description: "Evaluación Final Ordinaria 1º Curso",
          startDate: `${y2}-06-08`,
          endDate: `${y2}-06-10`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1210,
          description: "Plan Específico de Recuperación y Refuerzo (Junio)",
          startDate: `${y2}-06-11`,
          endDate: `${y2}-06-24`,
          category: "recuperacion",
          level: "curso",
    ...
    {
      id: "curso_fp_2_dual",
      name: "Plan FP 2º Curso Dual (FCE en Centro + Fase en Empresa FFEOE)",
      category: "2º Curso FP Dual",
      academicYear: `${y1}-${y2}`,
      events: [
        {
          id: 1301,
          description: "Inicio Formación Curricular en Centro (FCE - Bloque Intensivo)",
          startDate: `${y1}-09-15`,
          endDate: `${y2}-02-20`,
          category: "lectivo",
          level: "curso",
        ...
        {
          id: 1302,
          description: "Evaluación Previa al Acceso a Empresa (Convocatoria FCE)",
          startDate: `${y2}-02-16`,
          endDate: `${y2}-02-18`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1303,
          description: "Estancia Práctica en Empresa (Fase Dual FFEOE / FCT)",
          startDate: `${y2}-03-02`,
          endDate: `${y2}-06-10`,
          category: "dual",
          level: "curso",
        ...
        {
          id: 1304,
          description: "Tutorías Quincenales de Seguimiento Dual en Empresa",
          startDate: `${y2}-03-16`,
          endDate: `${y2}-05-29`,
          category: "tutoria",
          level: "curso",
        ...
        {
          id: 1305,
          description: "Defensa de Proyecto Integrado y Evaluación Final Dual",
          startDate: `${y2}-06-15`,
          endDate: `${y2}-06-19`,
          category: "evaluacion",
          level: "curso",
    ...
    {
      id: "curso_evaluaciones_examenes",
      name: "Calendario de Evaluaciones, Convocatorias y Juntas de Evaluación",
      category: "Evaluaciones Oficiales",
      academicYear: `${y1}-${y2}`,
      events: [
        {
          id: 1401,
          description: "Evaluación Inicial / Diagnóstica",
          startDate: `${y1}-10-06`,
          endDate: `${y1}-10-10`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1402,
          description: "1ª Sesión de Evaluación Parcial (1T)",
          startDate: `${y1}-12-10`,
          endDate: `${y1}-12-12`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1403,
          description: "2ª Sesión de Evaluación Parcial (2T)",
          startDate: `${y2}-03-24`,
          endDate: `${y2}-03-26`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1404,
          description: "Evaluación Final Ordinaria (3T / Anual)",
          startDate: `${y2}-06-08`,
          endDate: `${y2}-06-10`,
          category: "evaluacion",
          level: "curso",
        ...
        {
          id: 1405,
          description: "Evaluación Extraordinaria y Cierre de Actas de Junio",
          startDate: `${y2}-06-22`,
          endDate: `${y2}-06-24`,
          category: "evaluacion",
          level: "curso",
